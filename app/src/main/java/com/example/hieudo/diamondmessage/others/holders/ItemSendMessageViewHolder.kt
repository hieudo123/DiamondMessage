...
class ItemSendMessageViewHolder(view: View):ACRecyclerView.ACBaseViewHolder<QBChatMessage>(view) {
    private lateinit var tvContent : TextView
    private lateinit var tvDate : TextView
    override fun bindData(data: QBChatMessage?) {
        super.bindData(data)
        tvContent  = itemView.findViewById(R.id.itemSendMessage_tvContent)
        tvDate = itemView.findViewById(R.id.itemSendMessage_tvDate)
